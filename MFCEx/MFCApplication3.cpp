...
BEGIN_MESSAGE_MAP(CMFCApplication3App, CWinApp)
	...
	ON_COMMAND(ID_MNU_Test1, &CMFCApplication3App::OnMnuTest1)
	ON_COMMAND(ID_MNU_Draw, &CMFCApplication3App::OnMnuDraw)
END_MESSAGE_MAP()
...
void CMFCApplication3App::OnMnuTest1()
{
	//여기서 CDlgTest를 변형
	// TODO: 여기에 명령 처리기 코드를 추가합니다. 이벤트 처리기가 추가되었습니다.
	CDlgRev dlg;
	if (dlg.DoModal() == IDOK) AfxMessageBox(L"OK 버튼이 눌렸습니다.");
	else AfxMessageBox(L"취소 버튼이 눌렸습니다.");
}
